...
public class ArraysTester {
  ...
  private static void intToRoman() {
    int num = 4;
    N_NumberToRoman VNumberToRoman = new N_NumberToRoman();
  ...
  private static void rotateArray() {
    ...
    int noIfRotation = 2;
    K_RotateArray RRotateArray = new K_RotateArray(arr, noIfRotation);
    RRotateArray.rotateArray();
    System.out.println("Rotated Array = " + Arrays.toString(arr));
  }

  private static void tappingRainWater() {
    J_TappingRainWater QTappingRainWater =
        new J_TappingRainWater(new int[] {0, 1, 0, 2, 1, 0, 1, 3, 2, 1, 2, 1});
  ...
  private static void isJumpPossible() {
    int[] arr = {2, 3, 1, 1, 4};
    H_JumpGame OJumpGame = new H_JumpGame(arr);
  ...
  private static void containerWithMostWater() {
    ...
    A_ContainerWithMostWater NContainerWithMostWater = new A_ContainerWithMostWater(arr);
  ...
  private static void maxBuyAndSellProfit2() {
    ...
    E_BuyAndSellMaxProfit KBuyAndSellMaxProfit = new E_BuyAndSellMaxProfit(arr);
  ...
  private static void maxBuyAndSellProfit() {
    int[] arr = {7, 1, 5, 3, 6, 4};
    E_BuyAndSellMaxProfit KBuyAndSellMaxProfit1 = new E_BuyAndSellMaxProfit(arr);
    KBuyAndSellMaxProfit1.maxProfit1();
    System.out.println("Max Profit = " + KBuyAndSellMaxProfit1.maxProfit);

    int[] arr1 = {7, 6, 5, 4, 1};
    E_BuyAndSellMaxProfit KBuyAndSellMaxProfit2 = new E_BuyAndSellMaxProfit(arr1);
  ...
  private static void tripletToTargetSum() {
    ...
    int sum = 24;
    C_TripletToTargetSum ITripletToTargetSum = new C_TripletToTargetSum(arr, sum);
    System.out.println(
  ...
  private static void pairToTargetSum() {
    ...
    B_PairToTargetSumInArray HPairToTargetSumInArray = new B_PairToTargetSumInArray(arr, 13);
