...
public class InterviewQuestionTester {
  ...
  private static void intersectionOf2List() {
    ...
    System.out.println(
        "InterSection Start from = with O(n2) complexity "
            + intersection.intersectionOfLinkedList(list1, list2).value);
    System.out.println(
        "InterSection Start from = with Collection "
            + intersection.intersectionOfLinkedListUsingCollection(list1, list2).value);
    System.out.println(
        "InterSection Start from = with O(1) space complexity "
            + intersection.interSectionOfLinkedListWithLessSpaceComplexity(list1, list2).value);
  }
