...
public class SwapElements {
    ...
    public SwapElements(SinglyLinkedList list, int partitionElement){
        this.list = list;
    ...
    public void swap(){
        ...
        SinglyLinkedList leftList = null;
        SinglyLinkedList rightList = null;

        var headCopy = list.head;
        while (headCopy != null) {
            if (headCopy.value < partitionElement) {
                if (leftList == null){
                    leftList = new SinglyLinkedList();
                ...
                if (rightList == null){
                    rightList = new SinglyLinkedList();
