...
public class G_IntersectionOf2List {

  A_SinglyLinkedList list1;
  A_SinglyLinkedList list2;

  public G_IntersectionOf2List(A_SinglyLinkedList list1, A_SinglyLinkedList list2) {
    this.list1 = list1;
    this.list2 = list2;
  }

  public SingleLinkedListNode intersectionOfLinkedList(
