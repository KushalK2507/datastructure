package O_graph.adjacencyMatrix;
...
public class AdjacencyMatrixGraph {
    ...
    public void bfs(){
        populateNeighbours();
        graph.forEach(graphNode -> System.out.println("Neighbours of "+graphNode.val+" are : "+graphNode.neighbours.stream().map(graphNode1 -> graphNode1.val).collect(Collectors.joining())));
        System.out.println();
